...
/chui/theme/proc/generateHeader(list/params)
...
/chui/theme/base/generateButton(id, label)
	return {"<a class="button medium" id="[id]"><span class="top"></span>[label]<span class="bottom"></span></a>"}

/chui/theme/base/proc/generateSwitch(id, list/options)
...
/chui/theme/flock/generateFooter()
	return ..()

/chui/theme/flock/generateButton(id, awesomeIcon)
	return {"<a class='button' id='[id]'></span><i class='[awesomeIcon]'></i></a>"}

/chui/theme/flock/proc/generateTab(body, id)
	return {"
