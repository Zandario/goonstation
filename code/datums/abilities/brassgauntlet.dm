...
/obj/ability_button/stone_teleport/execute_ability()
...
/obj/ability_button/stone_animate/execute_ability()
	SPAWN(0)
...
/obj/ability_button/stone_power/execute_ability()
...
/obj/ability_button/stone_time/execute_ability()
	logTheThing(LOG_COMBAT, usr, "used the Brass Gauntlet and triggered the [src.name]'s effect at [log_loc(usr)]")
...
/obj/ability_button/stone_reality/execute_ability()
	logTheThing(LOG_COMBAT, usr, "used the Brass Gauntlet and triggered the [src.name]'s effect at [log_loc(usr)]")
	SPAWN(0)
		var/distance = 1
...
/obj/ability_button/stone_owl/execute_ability()
	logTheThing(LOG_COMBAT, usr, "used the Brass Gauntlet and triggered the [src.name]'s effect at [log_loc(usr)]")
	SPAWN(0)
...
/obj/ability_button/stone_gall/execute_ability()
	logTheThing(LOG_COMBAT, usr, "used the Brass Gauntlet and triggered the [src.name]'s effect at [log_loc(usr)]")
	SPAWN(0)
...
//Spookify
/proc/badstone(mob/user, obj/item/W, obj/item/clothing/B)
...
/proc/badmaterial(mob/user, obj/item/W, obj/item/clothing/B)
