/atom/movable/screen/ability/topBar/critter/clicked(params)
...
/datum/targetable/critter/updateObject()
	..()
	if (!src.object)
...
/datum/targetable/critter/proc/incapacitationCheck()
	var/mob/living/M = holder.owner
	return M.restrained() || is_incapacitated(M)

/datum/targetable/critter/castcheck()
...
/datum/targetable/critter/cast(atom/target)
	. = ..()
