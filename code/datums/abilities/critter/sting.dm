...
/datum/targetable/critter/sting/cast(atom/target)
	if (..())
		return TRUE
	if (isobj(target))
...
/datum/targetable/critter/sting/fermid_polymorph
	name = "Fermid Sting"
