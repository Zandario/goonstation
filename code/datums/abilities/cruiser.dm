/atom/movable/screen/ability/topBar/cruiser/clicked(params)
...
/datum/targetable/cruiser/updateObject()
	..()
	if (!src.object)
...
/datum/targetable/cruiser/proc/incapacitationCheck()
	var/mob/living/M = holder.owner
	return M.restrained() || is_incapacitated(M)

/datum/targetable/cruiser/castcheck()
...
/datum/targetable/cruiser/doCooldown()
	if (!holder)
		return
...
/datum/targetable/cruiser/cast(atom/target)
	. = ..()
