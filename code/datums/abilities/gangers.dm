...
/atom/movable/screen/ability/topBar/gang/clicked(params)
...
/datum/abilityHolder/gang/New()
	..()


/datum/abilityHolder/gang/disposing()
	..()

/datum/abilityHolder/gang/onLife(mult = 1)
	if(..()) return
...
/datum/targetable/gang/onAttach(datum/abilityHolder/H)
	..()
...
/datum/targetable/gang/updateObject()
	..()
	if (!src.object)
...
/datum/targetable/gang/castcheck()
	if (!holder)
		return 0
...
/datum/targetable/gang/cast(atom/target)
	. = ..()
...
/datum/targetable/gang/set_gang_base/cast()
