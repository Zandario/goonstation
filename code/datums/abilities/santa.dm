...
/atom/movable/screen/ability/topBar/santa/clicked(params)
...
/datum/abilityHolder/santa/New()
	..()

/datum/abilityHolder/santa/disposing()
	..()

/datum/abilityHolder/santa/onLife(mult = 1)
	if(..())
		return
...
/datum/targetable/santa/updateObject()
	..()
	if (!src.object)
...
/datum/targetable/santa/castcheck()
	if (!holder)
		return 0
...
/datum/targetable/santa/cast(atom/target)
	. = ..()
...
/datum/targetable/santa/heal/cast()
...
/datum/targetable/santa/gifts/cast()
...
/datum/targetable/santa/food/cast()
...
/datum/targetable/santa/warmth/cast()
...
/datum/targetable/santa/teleport/cast()
...
/datum/targetable/santa/banish/cast()
	var/datum/effects/system/harmless_smoke_spread/smoke = new /datum/effects/system/harmless_smoke_spread()
