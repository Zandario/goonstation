...
/datum/targetable/werewolf/werewolf_feast/cast(mob/target)
	if (!holder)
		return TRUE
...
/datum/action/bar/private/icon/werewolf_feast/New(Target, Feast)
	target = Target
	feast = Feast
	..()

/datum/action/bar/private/icon/werewolf_feast/onStart()
	..()
...
/datum/action/bar/private/icon/werewolf_feast/onUpdate()
	..()
...
/datum/action/bar/private/icon/werewolf_feast/onEnd()
	..()
...
/datum/action/bar/private/icon/werewolf_feast/onInterrupt()
	..()
