...
/datum/targetable/werewolf/werewolf_pounce/cast(turf/target)
	if (!holder)
		return TRUE
	...
	if (istype(M.loc,/turf))
		playsound(M.loc, 'sound/voice/animal/werewolf_attack2.ogg', 50, TRUE, 0, 1.4)
		playsound(M.loc, 'sound/effects/swoosh.ogg', 50, TRUE)
