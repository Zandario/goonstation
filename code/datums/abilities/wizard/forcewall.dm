...
/datum/targetable/spell/forcewall/cast()
	if(!holder)
		return
...
/obj/forcefield/disposing()
	valid = FALSE
	notify_neighbours()
	. = ..()

/obj/forcefield/proc/set_color()
	return

/obj/forcefield/proc/notify_neighbours()
...
/obj/forcefield/attackby(obj/item/I, mob/user)
	. = ..()
...
/obj/forcefield/artifact/New(obj/artifact/forcefield_generator/S)
	. = ..()
	source = S

/obj/forcefield/artifact/Bumped(AM)
	. = ..()
	if(source && ismob(AM))
