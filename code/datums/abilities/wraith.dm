...
/datum/abilityHolder/wraith/onAbilityStat()
	..()
	.= list()
...
/atom/movable/screen/ability/topBar/wraith/MouseEntered(location, control, params)
...
/datum/targetable/wraithAbility/New()
...
/datum/targetable/wraithAbility/cast(atom/target)
...
/datum/targetable/wraithAbility/doCooldown()
	if (!holder)
		return
...
/datum/targetable/wraithAbility/onAttach(datum/abilityHolder/holder)
	..()
...
/datum/targetable/wraithAbility/absorbCorpse/cast(atom/target)
	if (..())
		return 1
	if (!target)
...
/datum/targetable/wraithAbility/absorbCorpse/doCooldown() //This makes it so wraith early game is much faster but hits a wall of high absorb cooldowns after ~5 corpses
...
/datum/targetable/wraithAbility/possessObject/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/makeRevenant/cast(atom/T)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/decay/cast(atom/T)
	if (..())
		return TRUE
...
/datum/targetable/wraithAbility/command/cast(atom/T)
...
/datum/targetable/wraithAbility/raiseSkeleton/cast(atom/T)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/animateObject/cast(atom/T)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/haunt/cast()
	if (..())
		return 1
...
/datum/targetable/wraithAbility/spook/New()
	..()
...
/datum/targetable/wraithAbility/spook/proc/haunt_pda(obj/item/device/pda2/pda)
...
/datum/targetable/wraithAbility/spook/cast()
	if (..())
		return 1

/datum/targetable/wraithAbility/spook/proc/do_spook_ability(effect as text)
	if (effect == 8)
		effect = rand(1, 7)
	switch (effect)
		if (1)
...
/datum/targetable/wraithAbility/whisper/proc/ghostify_message(message)
	return message

/datum/targetable/wraithAbility/whisper/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/blood_writing/cast(atom/target, params)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/blood_writing/proc/write_on_turf(turf/T as turf, mob/user as mob, params)
...
// cast(turf/target, params)
/datum/targetable/wraithAbility/make_poltergeist/cast(atom/target, params)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/make_poltergeist/proc/make_poltergeist(mob/wraith/W, turf/T, tries = 0)
	if (!istype(W))
...
/datum/targetable/wraithAbility/specialize/New()
...
/datum/targetable/wraithAbility/specialize/cast()
	if (..())
		return 1

/datum/targetable/wraithAbility/specialize/proc/evolve(effect as text)
	var/datum/abilityHolder/wraith/AH = holder
...
/datum/targetable/wraithAbility/curse/cast(atom/target)
	if (..())
...
/datum/targetable/wraithAbility/curse/blood/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/curse/blindness/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/curse/enfeeble/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/curse/rot/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/curse/death/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/summon_rot_hulk/cast()
	if (..())
		return 1
...
/datum/targetable/wraithAbility/poison/cast(mob/target)
	if (!holder)
		return 1
...
/datum/targetable/wraithAbility/mass_whisper/proc/ghostify_message(message)
	return message

/datum/targetable/wraithAbility/mass_whisper/cast()
	if (..())
		return 1
...
/datum/targetable/wraithAbility/dread/cast(mob/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/possess/cast(mob/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/hallucinate/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/fake_sound/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/lay_trap/cast()
	if (..())
		return 1
...
/datum/targetable/wraithAbility/create_summon_portal/cast()
	if (..())
		return 1
...
/datum/targetable/wraithAbility/choose_haunt_appearance/cast(atom/target)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/harbinger_summon/cast(atom/target, params)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/harbinger_summon/proc/make_summon(mob/wraith/W, turf/T, tries = 0)
	if (!istype(W))
		boutput(W, "something went terribly wrong, call 1-800-CODER")
		return
...
// cast(turf/target, params)
/datum/targetable/wraithAbility/make_plague_rat/cast(atom/target, params)
	if (..())
		return 1
...
/datum/targetable/wraithAbility/make_plague_rat/proc/make_plague_rat(mob/W, turf/T, tries = 0)
...
/datum/targetable/wraithAbility/speak/cast(mob/target)
	if (!holder)
		return 1
