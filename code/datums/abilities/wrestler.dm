...
/mob/proc/make_wrestler(make_inherent = 0, belt_check = 0, remove_powers = 0, fake_wrestler = 0)
...
/atom/movable/screen/ability/topBar/wrestler/clicked(params)
...
/datum/abilityHolder/wrestler/deepCopy()
	. = ..()
...
/datum/targetable/wrestler/updateObject()
	..()
	if (!src.object)
...
/datum/targetable/wrestler/proc/incapacitation_check(stunned_only_is_okay = 0)
	if (!holder)
		return 0
...
/datum/targetable/wrestler/castcheck()
	if (!holder)
		return 0
...
/datum/targetable/wrestler/cast(atom/target)
	. = ..()
	actions.interrupt(holder.owner, INTERRUPT_ACT)
	return 0

/datum/targetable/wrestler/doCooldown()
