...
/datum/targetable/zoldorfAbility/New()
...
/datum/targetable/zoldorfAbility/cast(atom/target)
...
/datum/targetable/zoldorfAbility/fortune/New()
...
/datum/targetable/zoldorfAbility/fortune/cast(atom/target)
...
/datum/targetable/zoldorfAbility/addsoul/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	if((user.loc != user.homebooth)&&(user.homebooth != null))
		boutput(user,"<span class='alert'><b>You must be in your booth to use this ability!</b></span>")
		return
...
/datum/targetable/zoldorfAbility/removesoul/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	if((user.loc != user.homebooth)&&(user.homebooth != null))
		boutput(user,"<span class='alert'><b>You must be in your booth to use this ability!</b></span>")
		return
...
/datum/targetable/zoldorfAbility/omen/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	if((user.loc != user.homebooth)&&(user.homebooth != null))
		boutput(user,"<span class='alert'><b>You must be in your booth to use this ability!</b></span>")
		return 1
...
/datum/targetable/zoldorfAbility/brand/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	if((user.loc != user.homebooth)&&(user.homebooth != null))
		boutput(user,"<span class='alert'><b>You must be in your booth to use this ability!</b></span>")
		return 1
...
/datum/targetable/zoldorfAbility/astral/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	var/destination
...
/datum/targetable/zoldorfAbility/medium/cast(atom/target) //uses omen for the crystal ball animation and light, required setting the zoldorf to stat 2 to hear dead chat easily.
	var/mob/zoldorf/user = holder.owner
	var/obj/machinery/playerzoldorf/pz = user.homebooth
	if((user.loc != user.homebooth)&&(user.homebooth != null))
		boutput(user,"<span class='alert'><b>You must be in your booth to use this ability!</b></span>")
...
/datum/targetable/zoldorfAbility/manifest/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	if((user.loc != user.homebooth)&&(user.homebooth != null))
		boutput(user,"<span class='alert'><b>You must be in your booth to use this ability!</b></span>")
		return 1
...
/datum/targetable/zoldorfAbility/seance/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	if((user.loc != user.homebooth)&&(user.homebooth != null))
		boutput(user,"<span class='alert'><b>You must be in your booth to use this ability!</b></span>")
		return 1
...
/datum/targetable/zoldorfAbility/color/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	var/color
...
/datum/targetable/zoldorfAbility/notes/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	if(user.homebooth)
		var/obj/machinery/playerzoldorf/pz = user.homebooth
...
/datum/targetable/zoldorfAbility/jar/cast(atom/target)
	var/mob/zoldorf/user = holder.owner
	if(user.homebooth)
		var/obj/machinery/playerzoldorf/pz = user.homebooth
...
/datum/targetable/zoldorfAbility/help/cast(atom/target)
	if (..())
		return 1
	if (holder.help_mode)
		holder.help_mode = 0
