...
/datum/ai_rack_manager/proc/register_new_rack(obj/machinery/lawrack/new_rack)
...
/datum/ai_rack_manager/proc/unregister_rack(obj/machinery/lawrack/dead_rack)
...
/* ION STORM */
/datum/ai_rack_manager/proc/ion_storm_all_racks(picked_law="Beep repeatedly.", lawnumber=2, replace=true)
...
/datum/ai_rack_manager/proc/format_for_logs(glue = "<br>", round_end = FALSE, include_link = TRUE)
	var/list/laws = list()
	for(var/obj/machinery/lawrack/R in src.registered_racks)
