...
/datum/component/flock_ping/Initialize()
...
/datum/component/flock_ping/InheritComponent(datum/component/flock_ping/C, i_am_original)
	if (i_am_original)
		play_animation()
		src.end_time = TIME + duration

/datum/component/flock_ping/disposing()
	qdel(dummy)
	. = ..()

/datum/component/flock_ping/proc/play_animation()
