...
/atom/movable/screen/fullautoAimHUD/MouseDrag(over_object, src_location, over_location, src_control, over_control, params)
	SEND_SIGNAL(usr, COMSIG_FULLAUTO_MOUSEDRAG, over_object, over_location, over_control, params)

/atom/movable/screen/fullautoAimHUD/MouseDown(location, control, params)
	. = ..()
	SEND_SIGNAL(usr, COMSIG_FULLAUTO_MOUSEDOWN, src, location, control, params)

/atom/movable/screen/fullautoAimHUD/MouseMove(location, control, params)
	. = ..()
...
/datum/component/holdertargeting/fullauto/InheritComponent(datum/component/holdertargeting/fullauto/C, i_am_original, _delaystart, _delaymin, _rampfactor)
	if(C)
...
/datum/component/holdertargeting/fullauto/Initialize(delaystart = 1.5 DECI SECONDS, delaymin = 1.5 DECI SECONDS, rampfactor = 1)
...
/datum/component/holdertargeting/fullauto/UnregisterFromParent()
...
/datum/component/holdertargeting/fullauto/disposing()
	for(var/hudSquare in hudSquares)
...
/datum/component/holdertargeting/fullauto/on_pickup(datum/source, mob/user)
	var/obj/item/gun/G = parent
	. = ..()
...
/datum/component/holdertargeting/fullauto/on_dropped(datum/source, mob/user)
