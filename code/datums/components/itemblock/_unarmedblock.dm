...
/datum/component/wearertargeting/unarmedblock/on_equip(datum/source, mob/equipper, slot)
...
/datum/component/wearertargeting/unarmedblock/on_unequip(datum/source, mob/user)
	SHOULD_CALL_PARENT(0)
...
/datum/component/wearertargeting/unarmedblock/proc/on_block_begin(mob/living/carbon/source, obj/item/grab/block/B)
	if(affectedBlock)
...
/datum/component/wearertargeting/unarmedblock/proc/on_block_end(mob/living/carbon/source, obj/item/grab/block/B)
	if(affectedBlock)
		affectedBlock = null
