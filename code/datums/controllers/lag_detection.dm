...
/datum/controller/lag_detection/proc/setup()
...
/datum/controller/lag_detection/proc/process()
	tick_count++
...
/datum/controller/lag_detection/proc/automatic_profiling(force_stop=FALSE, force_start=FALSE)
...
/datum/controller/lag_detection/proc/delay_disable_manual_profiling(delay)
