...
/datum/mechanic_controller/proc/scan_in(N, T, list/M, locked)
...
/datum/electronics/scanned_item/proc/create_partslist(mats_number = 10)
...
/datum/electronics/scanned_item/proc/create_blueprint(mats_number = 10)
