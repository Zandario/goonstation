...
/datum/controller/process/critters/setup()
	name = "Critter"
	schedule_interval = 1.6 SECONDS

	detailed_count = new

/datum/controller/process/critters/copyStateFrom(datum/controller/process/target)
	var/datum/controller/process/critters/old_critters = target
	src.detailed_count = old_critters.detailed_count

/datum/controller/process/critters/doWork()
	var/i
...
/datum/controller/process/critters/tickDetail()
