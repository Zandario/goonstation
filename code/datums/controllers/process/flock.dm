...
/datum/controller/process/flock/setup()
	name = "Flock"
	schedule_interval = FLOCK_PROCESS_SCHEDULE_INTERVAL

/datum/controller/process/flock/copyStateFrom(datum/controller/process/target)
	var/datum/controller/process/flock/old_flock = target
	src.detailed_count = old_flock.detailed_count

/datum/controller/process/flock/doWork()
	var/i
...
/datum/controller/process/flock/tickDetail()
