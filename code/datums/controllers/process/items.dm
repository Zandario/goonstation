...
/datum/controller/process/items/setup()
	name = "Item"
...
/datum/controller/process/items/copyStateFrom(datum/controller/process/target)
...
/datum/controller/process/items/doWork()
	var/c
	...
	/*for(var/obj/item/item in processing_items)
		...
		scheck(currentTick)
*/
/datum/controller/process/items/tickDetail()
