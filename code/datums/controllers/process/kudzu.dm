...
/datum/controller/process/kudzu/setup()
	name = "Kudzu"
	schedule_interval = 3 SECONDS

	detailed_count = new

/datum/controller/process/kudzu/doWork()
	for (var/obj/spacevine/K in kudzu)
		if (K.run_life)
			K.Life()
			scheck()

/datum/controller/process/kudzu/copyStateFrom(datum/controller/process/target)
...
/datum/controller/process/kudzu/tickDetail()
