...
/datum/controller/process/machines/copyStateFrom(datum/controller/process/target)
...
/datum/controller/process/machines/proc/d_print()
...
#ifdef MACHINE_PROCESSING_DEBUG
/proc/register_machine_time(datum/machine, time)
	if(!machine) return
