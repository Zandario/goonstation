...
/datum/controller/process/sea_hotspot_update/setup()
...
/datum/controller/process/sea_hotspot_update/copyStateFrom(datum/controller/process/target)
...
/datum/controller/process/sea_hotspot_update/doWork()
	if (controller)
