...
/datum/controller/process/statusEffects/setup()
	name = "StatusEffects"
	schedule_interval = 0.3 SECONDS //Adjust as needed; Wouldnt go over 10.
	lastUpdate = world.timeofday

/datum/controller/process/statusEffects/copyStateFrom(datum/controller/process/target)
...
/datum/controller/process/statusEffects/doWork()
...
/datum/controller/process/statusEffects/tickDetail()
