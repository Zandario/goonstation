...
/datum/digital_filter/window_average
	init(window_size)
...
/datum/digital_filter/exponential_moving_average/proc/init_basic(input_weight)
...
/datum/digital_filter/exponential_moving_average/proc/init_exponential_smoothing(sample_interval, time_const)
