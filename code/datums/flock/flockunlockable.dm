...
/datum/unlockable_flock_structure/New(datum/flock/F)
	..()
	if(F)
		src.my_flock = F
	if(!src.structType)
...
/datum/unlockable_flock_structure/proc/process()
...
/datum/unlockable_flock_structure/proc/check_unlocked()
...
/datum/unlockable_flock_structure/relay/check_unlocked()
...
/datum/unlockable_flock_structure/collector/check_unlocked()
	return TRUE

/datum/unlockable_flock_structure/sentinel/
	structType = /obj/flock_structure/sentinel

/datum/unlockable_flock_structure/sentinel/check_unlocked()
	return TRUE
...
/datum/unlockable_flock_structure/gnesisturret/check_unlocked()
