...
/datum/game_mode/football/announce()
...
/datum/game_mode/football/pre_setup()
...
/datum/game_mode/football/post_setup()
	SPAWN(0)
...
/datum/game_mode/football/check_finished()
	if (time_left <= 0)
...
/datum/game_mode/football/proc/score_a_goal(team, points = 6)
...
/datum/game_mode/football/proc/update_scoreboard()
	src.update_score_numbers(red_num, score_red)
	src.update_score_numbers(blue_num, score_blue)


/datum/game_mode/football/proc/update_score_numbers(list/obj/decal/big_number/numbers, score)
	if (score >= 100)
...
/datum/game_mode/football/proc/update_game_clock()
...
/datum/game_mode/football/declare_completion()
...
/datum/game_mode/football/process()
	..()


/datum/game_mode/football/proc/put_me_in_coach()
...
/datum/game_mode/football/proc/init_player(mob/M, team = 0, is_new = 0)
...
/datum/game_mode/football/proc/reset_players(dead_only = 1)
...
/datum/game_mode/football/proc/clean_field()
