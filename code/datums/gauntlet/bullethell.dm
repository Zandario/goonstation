/proc/proj_tracer_tick(obj/projectile/O)
	var/update = 0
...
/proc/proj_tracer_on_end(obj/projectile/O)
	if ("1" in O.special_data)
		var/turf/T = O.special_data["1"]
		T.color = null
	if ("2" in O.special_data)
...
/datum/projectile/laser/light/tracer/tick(obj/projectile/O)
	proj_tracer_tick(O)

/datum/projectile/laser/light/tracer/on_end(obj/projectile/O)
...
/obj/bullethell/proc/setup_schedules()

/obj/bullethell/proc/setup_maxticks()
	maxticks.len = 0
...
/obj/bullethell/proc/update_overlays()
	if (invulnerability)
		if (overlay_status != 2)
			overlays.len = 0
...
#define DT_CORR   4
#define DT_ENERGY  5
/obj/bullethell/bullet_act(var/obj/projectile/O)
...
/obj/bullethell/proc/take_damage(damage, damtype)
	if (invulnerability)
		return
	last_damage = 0
...
/obj/bullethell/attackby(obj/item/W, mob/user)
	var/damtype = DT_NORMAL
...
/obj/bullethell/test1/setup_schedules()
	var/t = list()
	for (var/i = 0, i < 15, i++)
...
/obj/bullethell/test2/setup_schedules()
	var/t = list()
	var/t2 = list()
	for (var/i = 0, i < 10, i++)
...
/obj/bullethell/test3/setup_schedules()
	var/t = list()
	for (var/i = 0, i < 20, i++)
		if (i < 10)
...
/obj/bullethell/test4/setup_schedules()
	var/t = list()
	for (var/i = 0, i < 60, i++)
		t["[i+1]"] = list(i * 6)
	for (var/i = 0, i < 5, i++)
...
/obj/bullethell/test5/setup_schedules()
	var/t = list()
	var/t2 = list()
	for (var/i = 0, i < 10, i++)
		if (i % 2 == 0)
...
/obj/bullethell/test6/setup_schedules()
	var/t = list()
	var/t2 = list()
	for (var/i = 0, i < 10, i++)
		t["[i+1]"] = list(i * 9, i * 9 + 90, i * 9 + 180, i * 9 + 270)
