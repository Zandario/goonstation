/datum/hud/silicon/ai
	...
	var/atom/movable/screen/hud/cell
	var/atom/movable/screen/hud/tracking
	var/atom/movable/screen/hud/deploy
	var/atom/movable/screen/hud/apc
	var/atom/movable/screen/hud/status
	var/atom/movable/screen/hud/radio
	var/atom/movable/screen/hud/pda
	var/atom/movable/screen/hud/laws
	var/atom/movable/screen/hud/viewport
	var/atom/movable/screen/hud/hologram
	var/atom/movable/screen/hud/map
	var/atom/movable/screen/hud/core
	var/atom/movable/screen/hud/coreatk

	var/list/spinner = list("/", "-", "\\", "|")
	var/spinner_num = 1

/datum/hud/silicon/ai/New(M)
	..()
	master = M
...
/datum/hud/silicon/ai/clear_master()
	master = null
	..()

/datum/hud/silicon/ai/update_health()
	..()
...
/datum/hud/silicon/ai/proc/update()
	update_health()
	update_charge()
	update_tracking()

/datum/hud/silicon/ai/proc/update_charge()
	if (master.cell)
		var/powertext = ""
...
/datum/hud/silicon/ai/proc/update_tracking()
...
/datum/hud/silicon/ai/relay_click(id, mob/user, list/params)
	switch (id)
		if ("health")
			//output health info
