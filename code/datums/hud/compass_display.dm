...
/atom/movable/screen/compass_display/New(turf/loc, owner, target)
	..()
	src.owner = owner
	src.target = target
	needle = new (src)
...
/atom/movable/screen/compass_display/proc/process()
	if (!owner || !target)
		return
...
//WIRE TOOLTIPS
/atom/movable/screen/compass_display/MouseEntered(location, control, params)
...
/atom/movable/screen/compass_display/MouseExited()
	if (usr.client.tooltipHolder)
		usr.client.tooltipHolder.hideHover()

// /mob/verb/test_compass()
