...
/datum/hud/critter/flock/drone/New(M)
	..(M)
...
/datum/hud/critter/flock/drone/relay_click(id, mob/user, list/params)
...
/datum/hud/critter/flock/drone/proc/set_stunner_charge(charge)
