...
/datum/hud/ghost_observer/New(I)
	master = I
	..()
	update_ability_hotbar()

/datum/hud/ghost_observer/clear_master()
	master = null
	..()

/datum/hud/ghost_observer/proc/get_respawn_timer()
...
/datum/hud/ghost_observer/proc/get_join_other()
...
/datum/hud/ghost_observer/proc/update_ability_hotbar()
	if (!master.client)
		return
