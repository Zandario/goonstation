/datum/hud/pod
	...
	var/atom/movable/screen/hud/engine
	var/atom/movable/screen/hud/life_support
	var/atom/movable/screen/hud/comms
	var/atom/movable/screen/hud/sensors
	var/atom/movable/screen/hud/sensors_use
	var/atom/movable/screen/hud/weapon
	var/atom/movable/screen/hud/secondary
	var/atom/movable/screen/hud/lock
	var/atom/movable/screen/hud/set_code
	var/atom/movable/screen/hud/rts
	var/atom/movable/screen/hud/wormhole
	var/atom/movable/screen/hud/use_comms
	var/atom/movable/screen/hud/leave
	var/atom/movable/screen/hud/rcs
	var/atom/movable/screen/hud/lights
	var/atom/movable/screen/hud/tracking
	var/atom/movable/screen/hud/sensor_lock
...
/datum/hud/pod/clear_master()
	master = null
	..()

/datum/hud/pod/proc/detach_all_clients()
...
/datum/hud/pod/relay_click(id, mob/user, list/params)
	if (user.loc != master)
...
/datum/healthBar/New(barLength = 4, is_left = 0)
	..()
...
/datum/healthBar/proc/add_to_hud(datum/hud/H)
	for (var/atom/movable/screen/S in barBits)
		H.add_object(S)

/datum/healthBar/proc/add_to(mob/M)
	if (M.client)
		for (var/atom/movable/screen/S in barBits)
			M.client.screen += S

/datum/healthBar/proc/remove_from(mob/M)
	if (M.client)
		for (var/atom/movable/screen/S in barBits)
			M.client.screen -= S

/datum/healthBar/proc/update_health_overlay(health_value, health_max, shield_value, shield_max)
	for (var/atom/movable/screen/S in barBits)
		S.overlays.len = 0
...
/datum/healthBar/proc/add_overlay(value, max_value, r0, g0, b0, r1, g1, b1)
...
/datum/healthBar/proc/add_counter(bit, value, textcolor)
