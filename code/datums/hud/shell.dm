...
/datum/hud/shell/clear_master()
	master = null
	..()

/datum/hud/shell/relay_click(id)
	if (!master)
		return
...
/datum/hud/shell/proc/update_charge()
	if (master.cell)
...
/datum/hud/shell/proc/update_active_tool()
...
/datum/hud/shell/proc/update_tools()
...
/datum/hud/shell/proc/update_tool_selector()
	if (!master.module)
		return
...
/datum/hud/shell/proc/set_show_tool_selector(show)
