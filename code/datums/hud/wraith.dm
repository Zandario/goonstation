...
/datum/hud/wraith/clear_master()
	master = null
	..()

/datum/hud/wraith/relay_click(id, mob/user, list/params)
	if (id == "release")
		if (master)
			master.death(FALSE)
...
/datum/hud/wraith/proc/update_intent()
	intent.icon_state = "intent-[master.a_intent]"

/datum/hud/wraith/proc/update_health()
