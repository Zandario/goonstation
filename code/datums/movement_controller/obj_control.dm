...
/datum/movement_controller/obj_control/New(master)
	..()
	src.master = master

/datum/movement_controller/obj_control/disposing()
	master = null
	..()

/datum/movement_controller/obj_control/keys_changed(mob/user, keys, changed)
...
/datum/movement_controller/obj_control/process_move(mob/user, keys)
	if(!src.move_dir)
		return 0
...
/datum/movement_controller/obj_control/hotkey(mob/user, name)
	..()
	switch (name)
		if("exit")
...
/datum/movement_controller/obj_control/modify_keymap(client/C)
	..()
