...
/datum/movement_controller/tank/treads
	can_turn_while_parked = 1

/datum/movement_controller/tank/wheels
	can_turn_while_parked = 0
	delay_divisor = 12.5
	turn_delay = 2

/datum/movement_controller/tank/New(owner)
	..()
	src.owner = owner

/datum/movement_controller/tank/disposing()
	owner = null
	..()

/datum/movement_controller/tank/keys_changed(mob/user, keys, changed)
...
/datum/movement_controller/tank/process_move(mob/user, keys)
...
/datum/movement_controller/tank/update_owner_dir() //after move, update ddir
	if (owner.flying && owner.facing != owner.flying)
		owner.set_dir(owner.facing)

/datum/movement_controller/tank/modify_keymap(client/C)
	..()
	C.apply_keybind("pod")
