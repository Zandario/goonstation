...
/kText
	...
	// padText() sides
	var/const/PAD_LEFT  = 1
	var/const/PAD_RIGHT = 2
	var/const/PAD_BOTH  = 3  // centers the text

	// ascii values, for convenience.
	var/const/ASCII_SPACE     = 32
	var/const/ASCII_LINEBREAK = 10
	var/const/ASCII_TAB       = 9
 ...
 */
/kText/proc/getCharacter(string, pos=1)
 ...
 */
/kText/proc/isWhitespace(string, pos=1)
 ...
 */
/kText/proc/trimWhitespace(string)
 ...
 */
/kText/proc/findNextWhitespace(string, pos=1)
 ...
 */
/kText/proc/findWhich(string, sub, which=1)
	if(which==1)
 ...
 * @see kText.findWhich()
 */
/kText/proc/findWhichCase(string, sub, which=1)
	if(which==1)
 ...
 */
/kText/proc/text2list(string, delimiter=" ")
 ...
 * @see kText.text2list()
 */
/kText/proc/text2listCase(string, delimiter=" ")
	var/list/listified = new, last=1
 ...
 */
/kText/proc/list2text(list/list, delimiter=" ")
 ...
 */
/kText/proc/replaceText(string, sub, replace)
 ...
 */
/kText/proc/replaceTextCase(string, sub, replace)
	var/replacified, last=1
 ...
 *			"-ABC--".
 */
/kText/proc/padText(string, size=12, padSide=PAD_LEFT, padCharacter=" ")
 ...
 */
/kText/proc/autoBreak(string, charsPerLine=50)
 ...
 */
/kText/proc/autoComplete(string, needle)
	if(islist(string))
 ...
 */
/kText/proc/autoCompleteCase(string, needle)
	if(islist(string))
		for(var/entry in string)
			// to remain consistent, and allow for embedded lists, this is necessary.
 ...
 */
/kText/proc/matchKeys(string, needle)
 ...
 * @see kText.matchKeys()
 */
/kText/proc/matchKeysCase(string, needle)
 ...
 */
/kText/proc/repeatText(string, count=2)
 ...
 */
/kText/proc/file2list(file, delimiter="\n")
 ...
 * @see kText.file2list()
 */
/kText/proc/file2listCase(file, delimiter="\n")
	if(!isfile(file) || !fexists(file))
		return
 ...
 */
/kText/proc/hasPrefix(string, prefix)
 ...
 * @see kText.hasPrefix()
 */
/kText/proc/hasPrefixCase(string, prefix)
 ...
 */
/kText/proc/hasSuffix(string, suffix)
 ...
 * @see kText.hasSuffix()
 */
/kText/proc/hasSuffixCase(string, suffix)
	var/start = length(string)-length(suffix)+1
	if(start<1)
		return 0
 ...
 */
/kText/proc/limitText(string, length)
	if(length < 1)
		return null
